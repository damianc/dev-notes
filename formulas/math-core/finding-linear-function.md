...
$$
I_x = \left( \frac{d-b}{a-c} \right) = \left( \frac{-2-3}{-0.5-4} \right) = \frac{-5}{-4.5} = 1.1111
$$

$$
I = (I_x, f(I_x)) = (1.1111, 2.4445)
$$

* init rays lengths

$$
\theta_f = \frac{1}{\sqrt{1+a^2}} = \frac{1}{\sqrt{1.25}} = 0.894427
$$

$$
\theta_g = \frac{1}{\sqrt{1+c^2}} = \frac{1}{\sqrt{17}} = 0.242536
$$

* init rays ends

$$
P_x = I_x + \theta_f \cdot \vec{p} = 1.1111 + 0.894427 = 2.005527
$$

$$
P = (P_x, f(P_x)) = (2.005527, 1.997237)
$$

$$
Q_x = I_x + \theta_g \cdot \vec{q} = 1.1111 - 0.242536 = 0.868564
$$

$$
Q = (Q_x, g(Q_x)) = (0.868564, 1.474256)
$$

* existing sides lengths

$$
|IP| = \sqrt{(P_x-I_x)^2 + (P_y-I_y)^2} = \sqrt{(2.005527-1.1111)^2 + (1.997237-2.4445)^2} = \sqrt{0.80 + 0.200044} = 1.000022
$$

$$
|IQ| = \sqrt{(Q_x-I_x)^2 + (Q_y-I_y)^2} = \sqrt{(0.868564-1.1111)^2 + (1.474256-2.4445)^2} = \sqrt{0.058824 + 0.941373} = 1.000099
$$

$$
|PQ| = \sqrt{(Q_x-P_x)^2 + (Q_y-P_y)^2} = \sqrt{(0.868564-2.005527)^2 + (1.474256-1.997237)^2} = \sqrt{1.292685 + 0.273509} = 1.251477
$$

* getting proportions

$$
s = |IP| + |IQ| + |PQ| = 1.000022 + 1.000099 + 1.251477 = 3.251598
$$

$$
\ell' = \ell - s = 12 -  3.251598 = 8.748402
$$

$$
R = \frac{s}{|IP| + |IQ|} = \frac{3.251598}{2.000121} = 1.625701
$$

$$
\vec{R} = \frac{\ell'}{R} = \frac{8.748402}{1.625701} = 5.381311
$$

$$
\vec{r} = \frac{\vec{R}}{2} = \frac{5.381311}{2} = 2.690656
$$

* rays new ends

$$
P'_x = Px + \vec{p} \cdot \frac{\vec{r}}{\sqrt{1+a^2}} = 2.005527 + \frac{2.657283}{1.118034} = 4.382273
$$

$$
P' = (P'_x, f(P'_x)) = (4.382273, 0.808864)
$$

$$
Q'_x = Qx + \vec{q} \cdot \frac{\vec{r}}{\sqrt{1+c^2}} = 0.868564 - \frac{2.657283}{4.123106} = 0.224078
$$

$$
Q' = (Q'_x, g(Q'_x)) = (0.224078, -1.103688)
$$

* final function

$$
a_h = \frac{Q'_y - P'_y}{Q'_x - P'_x} = \frac{-1.103688-0.808864}{0.224078-4.382273} = \frac{-1.912552}{-4.158195} = 0.459948
$$

$$
b_h = \frac{Q'_xP'_y - P'_xQ'_y}{Q'x - P'_x} = \frac{
0.224078\cdot0.808864 - 4.382273\cdot(-1.103688)
}{0.224078-4.382273} = \frac{0.181249+4.836662}{-4.158195} = \frac{5.017911}{-4.158195} = -1.206752
$$

$$
h(x) = a_hx + b_h = 0.459948x - 1.206752
$$
